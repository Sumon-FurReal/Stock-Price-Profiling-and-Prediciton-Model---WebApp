...
with st.sidebar:
    ...
    st.info("This applicaiton allows you to perform exploratory data analysis(EDA) and predict stock price")


if choice == "Upload Stock Data":
    st.header("Upload your data for modeling   :chart_with_upwards_trend:")
...
if choice == "EDA - Profiling":
    st.header("Exploratory Data Analysis - Profiling  :mag:")
...
if choice == "Predict Stock Price":
    if os.path.exists("source.csv"):
        ...
        st.title("Stock Prediction  :crystal_ball:")
